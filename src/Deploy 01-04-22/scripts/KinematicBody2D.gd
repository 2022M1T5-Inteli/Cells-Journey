...
var direcao_player = 0 #variavel que define a direção do personagem dependendo da direção de onde o personagem esta olhando
var parado = 1 #variavel que serve para 
#var vida = 6
var viloes = ["vilao1","vilao_2","vilao_3","vilao_4","vilao_5","FumacaBraba","CigarroBrabo"]
